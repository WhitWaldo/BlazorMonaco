...
{
    public class MonacoEditorBase : ComponentBase, IDisposable
    {
        [Parameter]
        ...
        private Dictionary<string, Action<MonacoEditorBase, int[]>> actions { get; set; } =
            new Dictionary<string, Action<MonacoEditorBase, int[]>>();

        private Dictionary<string, Action<MonacoEditorBase, int>> commands { get; set; } =
            new Dictionary<string, Action<MonacoEditorBase, int>>();
        ...
        public static async Task<string> ColorizeModelLine(TextModel model, int lineNumber, int? tabSize = null)
        {
            if (staticJsRuntime == null)
                return default;
            return await staticJsRuntime.InvokeAsync<string>("blazorMonaco.editor.colorizeModelLine", model.Uri,
                lineNumber, tabSize);
        }

        protected static async Task Create(string id, StandaloneEditorConstructionOptions options,
            DotNetObjectReference<MonacoEditorBase> jsObjectRef)
        {
            if (staticJsRuntime == null)
                return;
        ...
        protected static async Task CreateDiffEditor(string id, DiffEditorConstructionOptions options,
            DotNetObjectReference<MonacoEditorBase> jsObjectRef)
        {
            if (staticJsRuntime == null)
                return;
        ...
        public static async Task<TextModel> CreateModel(string value, string language = null, string uri = null)
        {
            if (staticJsRuntime == null)
                return default;
            var model = await staticJsRuntime.InvokeAsync<TextModel>("blazorMonaco.editor.createModel", value, language,
                uri);
            if (model != null)
        ...
        public async Task AddAction(string actionId, string label, int[] keyCodes, string precondition,
            string keybindingContext, string contextMenuGroupId, double contextMenuOrder,
            Action<MonacoEditorBase, int[]> action)
        {
            ...
            await jsRuntime.InvokeVoidAsync("blazorMonaco.editor.addAction", Id, actionId, label, keyCodes,
                precondition, keybindingContext, contextMenuGroupId, contextMenuOrder);
        }
        ...
        public async Task RevealLineInCenterIfOutsideViewport(int lineNumber, ScrollType? scrollType = null)
        {
            if (jsRuntime == null)
                return;
            await jsRuntime.InvokeVoidAsync("blazorMonaco.editor.revealLineInCenterIfOutsideViewport", Id, lineNumber,
                scrollType);
        }
        ...
        public async Task RevealLines(int startLineNumber, int endLineNumber, ScrollType? scrollType = null)
        {
            if (jsRuntime == null)
                return;
            await jsRuntime.InvokeVoidAsync("blazorMonaco.editor.revealLines", Id, startLineNumber, endLineNumber,
                scrollType);
        }
        ...
        public async Task RevealLinesInCenter(int startLineNumber, int endLineNumber, ScrollType? scrollType = null)
        {
            if (jsRuntime == null)
                return;
            await jsRuntime.InvokeVoidAsync("blazorMonaco.editor.revealLinesInCenter", Id, startLineNumber,
                endLineNumber, scrollType);
        }

        public async Task RevealLinesInCenterIfOutsideViewport(int startLineNumber, int endLineNumber,
            ScrollType? scrollType = null)
        {
            if (jsRuntime == null)
                return;
            await jsRuntime.InvokeVoidAsync("blazorMonaco.editor.revealLinesInCenterIfOutsideViewport", Id,
        ...
        public async Task RevealPositionInCenterIfOutsideViewport(Position position, ScrollType? scrollType = null)
        {
            if (jsRuntime == null)
                return;
            await jsRuntime.InvokeVoidAsync("blazorMonaco.editor.revealPositionInCenterIfOutsideViewport", Id, position,
                scrollType);
        }
        ...
        public async Task RevealRangeInCenterIfOutsideViewport(Range range, ScrollType? scrollType = null)
        {
            if (jsRuntime == null)
                return;
            await jsRuntime.InvokeVoidAsync("blazorMonaco.editor.revealRangeInCenterIfOutsideViewport", Id, range,
                scrollType);
        }
